...
sequence_motivation = torch.from_numpy(bert_model_raw([train_input['motivation'][0], train_input['motivation'][1], train_input['motivation'][2]]).numpy())
sequence_emotion = torch.from_numpy(bert_model_raw(train_input['emotion'][0], train_input['emotion'][1], train_input['emotion'][2]).numpy())
